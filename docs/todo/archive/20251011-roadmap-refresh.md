...
- [x] 新ロードマップ案（6 stage + 3/4 HITL）のフェーズ構成・成果物・完了条件を整理し、ロードマップ更新方針メモを作成する
...
- [x] `AGENTS.md` および関連ガイドの記載対象を整理し、各ドキュメントで参照すべき資料（design/requirements/policies 等）を明示する
  - メモ: `docs/AGENTS.md`, `src/AGENTS.md`, `tests/AGENTS.md` から stage 詳細を排除し、参照先や更新手順の指針を加える
- [x] `README.md` と `docs/design/` に新パイプライン（6 stage＋HITL＋AI レビュー）の概要と利用手順を追記する
...
- 文字量とレイアウト制約のフォールバックルールを決定し、品質チェック stage と合わせて整理する
- コンテンツ/HITL stage（3・4）の承認 UX・権限モデルを別ドキュメントで設計する
