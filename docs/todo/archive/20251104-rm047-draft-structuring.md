---
目的: 工程4でプレペアとテンプレ spec を統合し `draft_approved.json` の生成基盤を整備する
...
- [x] 計画策定（スコープ・前提の整理）
  - メモ: 
      1. **前提調査と要件整理**  
         - `docs/requirements/stages/stage-04-draft-structuring.md`、`docs/design/design.md`、`docs/notes/20251102-stage2-jobspec-overview.md` を読み合わせ、工程2 出力（`jobspec.json`）と工程3 出力（`prepare_card.json` など）の項目を洗い出す。  
