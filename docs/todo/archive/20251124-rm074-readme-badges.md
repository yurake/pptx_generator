...
- [x] PR 作成
  - メモ: PR #307 (ci: SonarCloud 連携と README バッジ整備) を 2025-11-24 に作成し、https://github.com/yurake/pptx_generator/pull/307 へ提出済み。テンプレート記載事項と Plan 承認情報を反映済み。

## メモ
- 設計方針の確定・共有およびチェックリスト整合を完了し、PR #307 を提出済み。レビュー対応とマージ後の ToDo アーカイブを待つ。
