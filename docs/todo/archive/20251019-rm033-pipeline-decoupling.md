---
目的: stage 3/4独立 CLI 化に向けた要件整理とプロトタイプ設計・実装・検証を行い、RM-033 の初動を完了させる
関連ブランチ: feat/rm033-pipeline-decoupling
関連Issue: #218
roadmap_item: RM-033 パイプライン stage 3/4独立化準備
---
...
- [x] 設計・実装方針の確定
  - メモ: stage 3/4 CLI のコマンド仕様・テスト戦略・ドキュメント更新方針は `docs/design/cli/cli-command-reference.md` に集約。
- [x] ドキュメント更新（要件・設計）
  - メモ: `docs/requirements/stages/stage-02-prepare.md` と `docs/design/stages/stage-03-compose.md` に CLI 連携を追記し、`docs/design/cli/cli-command-reference.md` に集約。
