...
- [x] 設計・実装方針の確定
  - メモ: `docs/notes/rm084-refactorability-assessment.md`（2025-11-30）に CLI prepare 再編方針と責務分離メモを記録済み。追加論点なし。
  - [x] 設計・実装方針メモの共有（必要な場合に docs/notes 等へのリンクを記載）
    - メモ: 上記ノートの「2025-11-30 CLI ハンドラ再編メモ」で共有済み。
...
- [x] ドキュメント更新
  ...
  - [x] README.md / AGENTS.md
    - メモ: Upfront 情報の更新不要。
- [x] 関連Issue 行の更新
  - メモ: フロントマターの `関連Issue` を `#343` に設定済み。進捗共有は本 ToDo で管理する。
- [x] チェックリスト整合確認
  - メモ: 2025-12-02 時点で未完タスクは「PR 作成」のみ。その他は親子タスクとも完了状態。
- [ ] PR 作成
