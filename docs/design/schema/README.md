...
- `stage-02-content-normalization.md`: `prepare_card.json`, `prepare_log.json`, `prepare_ai_log.json`, `ai_generation_meta.json`, `prepare_story_outline.json`, `audit_log.json`。
...
## 更新手順
1. 変更内容と影響範囲を洗い出す（関連 stage・モジュール・テスト）。
