# ドキュメント構成
- `docs/policies/context-engineering.md` を起点に、下位カテゴリへ順に進むことを想定した索引です。
- カテゴリを更新・追加する際は、該当 README と関連ポリシーを併せて更新してください。
...
- `docs/assets/README.md`: 資産構造・命名規則・更新手順をまとめた運用ガイド。
