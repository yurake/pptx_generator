...
10. テンプレ運用サポート
   ...
   - `samples/templates/templates.pptx` をベースに 50 ページ規模のサンプルテンプレート群を維持し、カテゴリ別（セクション、KPI、プロセス、リスクなど）のレイアウトとアンカー命名ルールを `samples/json/sample_spec.json` / `sample_layouts.jsonl` に反映すること。
