...
| フェーズB: 自動パイプライン実装 | 2025-11-09 〜 2025-12-15 | コンテンツ正規化〜ドラフト構成の HITL ワークフロー整備と自動工程接続 | 縮約ポリシー、レイアウトスコアリング、承認 UI / API、CLI パイプライン |
| フェーズC: 品質・監査・運用 | 2025-12-16 〜 2026-01-31 | 自動整合チェックと監査基盤の強化 | 軽量検査拡張、Polisher 連携、監査ログワークフロー |
...
- ゴール: 全自動パワポ生成パイプラインの戦略を整理し、6 工程（③・④ HITL 含む）のフェーズ構成・KPI・フォールバックポリシーを文書化する。
