...
graph TD
    ...
    RM003["RM-003 ビジュアルフィードバックコパイロット\n(調査中)"]
    RM004["RM-004 営業ナレッジ連携自動化\n(準備中)"]
    RM005["RM-005 プレゼンストーリーモデラー\n(企画中)"]
    RM006["RM-006 ライブ共同編集アシスト\n(アイデア段階)"]
    RM016["RM-016 PDF 自動生成対応\n(完了)"]
    RM017["RM-017 パイプライン機能拡張\n(完了)"]
    RM018["RM-018 レンダラー リッチコンテンツ対応\n(完了)"]
