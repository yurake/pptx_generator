...
<a id="rm-998"></a>
### RM-998 自動化再検証（優先度: P0）
- ゴール: 修正済みワークフローが ToDo とロードマップを正常に更新することを確認する。
- 参照 ToDo: [docs/todo/20251009-auto-test2.md](../todo/20251009-auto-test2.md)
- 状況: 0/4 件実施（テスト開始前）
- 次のアクション: 検証用 PR 作成とマージ、結果のレビュー。
