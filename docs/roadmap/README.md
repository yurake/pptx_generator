...
| 工程 | 概要 | 主なタスク例 | 現状 |
| --- | --- | --- | --- |
| 1. テンプレ準備 | テンプレ資産 (.pptx) の整備と版管理 | テンプレ命名整合性チェック、テンプレ更新ポリシー整備、`templates/` 運用 | RM-015, RM-008, RM-009, RM-010 |
| 2. テンプレ構造抽出 | テンプレ構造 JSON / ヒント値の生成 | `extract-template` CLI、レイアウト差分検証、テンプレ運用ガイド更新 | RM-015, RM-008, RM-009, RM-010 |
| 3. コンテンツ正規化 (HITL) | `content_approved.json` 承認までの整形 | AI レビュー、Auto-fix、承認 UI、外部データ連携 | RM-015, RM-004, RM-005, RM-006 |
| 4. ドラフト構成設計 (HITL) | `draft_approved.json` 承認までの章立て | ストーリーボード UI、レイアウトヒント、承認ログ | RM-015, RM-004, RM-005, RM-006 |
| 5. マッピング | レイアウト割付と `rendering_ready.json` 作成 | レイアウトスコアリング、縮約ポリシー、アンカー活用 | RM-015, RM-001, RM-007, RM-008, RM-011, RM-012, RM-014 |
| 6. PPTX レンダリング | 最終出力と監査メタ付与 | 軽量整合チェック、Polisher 連携、監査ログ強化 | RM-015, RM-001, RM-003, RM-011, RM-012, RM-013, RM-014 |

工程ごとの優先度は状況に応じて変動するため、各 RM の「対象工程」欄を参照しながら柔軟にタスクを切り替える。
