...
<a id="rm-098"></a>
### RM-098 精度改善
- ゴール: 動的・静的テンプレート対応を含む、パイプライン全体の精度改善を実施する。
- 対象 stage: 全 stage 横断
- 参照ドキュメント: （作成予定）
- 参照 ToDo: [docs/todo/20260107-rm098-accuracy-improvement.md](../todo/20260107-rm098-accuracy-improvement.md)
- 依存: なし（新規テーマ）
- 状況: 未着手（2026-01-07 追加）
- 期待成果:
  - 動的・静的テンプレート両対応の精度向上
  - パイプライン全体の品質改善
  - 複数 stage にまたがる改善の実施
