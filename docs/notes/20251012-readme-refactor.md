...
> **更新情報 (2025-11-03)**: README は 4 工程構成（テンプレ工程 → コンテンツ準備 → マッピング → レンダリング）へ更新済み。以下のメモは 5 工程体制を前提とした当時の改善案として参照する。
...
2. **工程別の操作ガイド**
   ...
   - 工程 3: コンテンツ準備（HITL）。`docs/requirements/stages/stage-03-...` など参照し、ワークシート例を記載。自動化は今後の検討と記載。
