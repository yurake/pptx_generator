...
- 2025-10-06 (午前): 開発端末で `uv run pptx gen .pptx/compose/generate_ready.json --export-pdf --output .pptx/gen/rehearsal` を実行したが、`soffice` が検出できず Exit Code 5（LibreOffice 不足）で失敗。
