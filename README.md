...
| 工程3〜6 一括 | `uv run pptx gen samples/json/sample_jobspec.json --template samples/templates/templates.pptx --branding .pptx/extract/branding.json` | `.pptx/gen/proposal.pptx`（`proposal.pdf` 任意） | パイプライン後半をまとめて実行 |
